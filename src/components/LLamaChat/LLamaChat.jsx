...
function LLamaChat() {
    ...
    return (
        <>
            <div className={`chat-container ${isCollapsed ? 'chat-container-collapsed' : ''} ${isMobile ? 'mobile' : ''} ${isTablet ? 'tablet' : ''} ${isLaptop ? 'laptop' : ''} ${isDesktop ? 'desktop' : ''}`}>
            ...
            <div className={`cart-container ${isCartCollapsed ? 'cart-container-collapsed' : ''} ${isMobile ? 'mobile' : ''} ${isTablet ? 'tablet' : ''} ${isLaptop ? 'laptop' : ''} ${isDesktop ? 'desktop' : ''}`}>
            ...
            <div className="order-block">
                {!isCartCollapsed ? (
                        <button
                            className={`order-button-floating ${!isCollapsed && !isCartCollapsed ? 'chat-expanded' : ''} ${isMobile ? 'mobile' : ''} ${isTablet ? 'tablet' : ''} ${isLaptop ? 'laptop' : ''} ${isDesktop ? 'desktop' : ''}`}
                            onClick={async () => {
                                await handleOrder();
                                setCart([]);
                            }}
